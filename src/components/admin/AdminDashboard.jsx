...
const navigation = [
  ...
  { name: 'Transações', href: '/admin/transactions', icon: CalendarIcon, current: false },
...
const teams = [
  { id: 1, name: 'Administradores', href: '/admin/teams/admin', initial: 'A', current: false },
  { id: 2, name: 'Usuários', href: '/admin/teams/users', initial: 'U', current: false },
...
export default function AdminDashboard({ children, currentPage = 'dashboard' }) {
  const [sidebarOpen, setSidebarOpen] = useState(false)

  // Atualizar navegação atual baseada na página atual
                ...
                <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-4 ring-1 ring-white/10">
                  ...
                  <nav className="flex flex-1 flex-col">
                    <ul role="list" className="flex flex-1 flex-col gap-y-7">
                      ...
                      <li>
                        <div className="text-xs leading-6 font-semibold text-gray-400">Equipes</div>
