...
async function testarEmail() {
  ...
  try {
    ...
    if (error.code === 'EAUTH') {
      ...
      console.error('1. Se o e-mail está correto');
      console.error('2. Se a senha de app está correta (16 caracteres)');
      console.error('3. Se a verificação em 2 etapas está ativada');
      console.error('4. Se a senha de app foi gerada corretamente');
    }
